...
const FileUpload = () => {
  ...
  const [isLoading, setIsLoading] = useState(false); // For the loader
  const [isError, setIsError] = useState(false); // For error indication
  ...
  const styles = {
    ...
    message: {
      marginTop: "15px",
      fontSize: "14px",
      color: isError ? "red" : "green", // Conditional color for success or error
    },
    loader: {
      margin: "10px auto",
